...
//   // Deal with a product image: show the product image as the card hero,
//   // store logo appears as a small badge in the bottom-left corner.
...
//           ${hasDealImage ? '' : 'bg-[#f7f6f3]'}`}>

//           {hasDealImage ? (
//             /* Product image fills the hero */
//             <img
//               src={item.imageUrl}
//               alt={item.title}
...
//               <TimerIcon className="w-3 h-3 mr-1 inline" /> {expLabel}
//             </span>
//           )}
...
//           {/* Store logo badge — bottom-left, only when a product image is shown */}
//           {hasDealImage && (
